...
void compute_single_histogram(hel_algo_mode_t algo_mode, ZZX* hist, int subkey_number, hel_data_t* data, hel_histo_t* histo, hel_enum_input_t* enum_input, hel_preprocessing_t* preprocess){
